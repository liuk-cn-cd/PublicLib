...
/*!
 * @class	: ICommandExecutorUser
 * @brief	: 命令执行器观察者
 * @author	: liuk
 * @date	: 2016/12/24 15:15
 */
class TASKLIB_EXPORT ICommandExecutorUser
{
public:
    ICommandExecutorUser();
    virtual ~ICommandExecutorUser();
public:
	/**
	 * @fn		: OnCommadExecute
...
public:
	...
	*/
    ...
    void Attach(ICommandExecutorUser* pUser);
private:
	CTask m_cmdTask;
    ICommandExecutorUser* m_pUser;
